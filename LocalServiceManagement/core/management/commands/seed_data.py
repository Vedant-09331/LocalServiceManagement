...
class Command(BaseCommand):
    help = "Seeds the database with example data for all functionalities."
    ...
    def handle(self, *args, **options):
        ...
        reviews_data = [
            ...
            {'user': user2, 'service': created_services[0], 'rating': 4, 'comment': 'Very good job, just took a bit longer than expected. Overall happy.'},
